...
Environment Variables:
  ...
  ANTHROPIC_API_KEY   Anthropic API key for Claude
    ...
    notify_parser.add_argument('title', nargs='?', default='Cortex')
    notify_parser.add_argument('message', nargs='?', default='Msg')
    notify_parser.add_argument('--dnd-toggle', action='store_true')
    notify_parser.add_argument('--config', action='store_true')
    # Health command
